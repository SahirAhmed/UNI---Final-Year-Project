...
import './CharityLandingPageCardStyles.css';
...
const CharityLandingPageCard = ({userid, individualacc}) => {
  ...
  const handleClandingpageGet=async()=>{

    try{
            let response =  await ApiCallGet('/charitylandingpage/' + window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1))
                        ...
                        <form>
                            ...
                            <PayPalButton
                                ...
                                onSuccess={(details, data) => {               
                                  ...
                                  const handleChangeCharity = async () => {
                                      let newEdit ={
                                        total_raised: state,
                                      };
                                      console.log(newEdit);
                                      ...
                                      try {
                                        let response =  await ApiCallPatch(`/charitylandingpage/`+ window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1), newEdit);
                                  ...
                                  const handleChangeIndividual = async () => {
                                    ...
                                    try {
                                      let response =  await ApiCallPatch(`/individualdonateeffect`, newEdit);
                                      console.log(response.data);
                                      Toast("Payment Successful, Refresh to see changes!","success")        
...
export default CharityLandingPageCard